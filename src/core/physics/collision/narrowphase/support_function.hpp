...
public:
    ShapeSupportFunction(const Shape *s, const Vec3f &org) : shape(s), origin(org)
    {
    }
...
public:
    MinkowskiDifferenceSupportFunction(const SupportFunction &a, const SupportFunction &b) : shape_a(a), shape_b(b)
    {
    }
