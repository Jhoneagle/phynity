...
public:
    ...
    static SATCollisionResult test_convex_hull_2d(const ConvexHull2D &hull_a,
    ...
    /// @return Collision result with penetration info
    static SATCollisionResult test_convex_hull_3d(const ConvexHull3D &hull_a,
...
private:
    ...
    static SATAxisTest test_axis_2d(const ConvexHull2D &hull_a,
                                    const ConvexHull2D &hull_b,
                                    const Vec3f &axis,
    ...
    static SATAxisTest
    test_axis_3d(const ConvexHull3D &hull_a, const ConvexHull3D &hull_b, const Vec3f &axis, const Vec3f &offset);
    ...
    static std::pair<float, float> project_hull_2d(const ConvexHull2D &hull, const Vec3f &axis, const Vec2f &offset);

    /// Project all vertices of a 3D hull onto an axis
    static std::pair<float, float> project_hull_3d(const ConvexHull3D &hull, const Vec3f &axis, const Vec3f &offset);

    /// Find closest points on two line segments for contact point estimation
    static Vec3f find_contact_point_2d(const ConvexHull2D &hull_a,
                                       const ConvexHull2D &hull_b,
                                       const Vec3f &normal,
                                       const Vec2f &offset);

    /// Find contact point on a 3D edge
    static Vec3f find_contact_point_3d(const ConvexHull3D &hull_a,
                                       const ConvexHull3D &hull_b,
                                       const Vec3f &normal,
                                       const Vec3f &offset);
...
SATSolver::project_hull_2d(const ConvexHull2D &hull, const Vec3f &axis, const Vec2f &offset)
{
...
inline std::pair<float, float>
SATSolver::project_hull_3d(const ConvexHull3D &hull, const Vec3f &axis, const Vec3f &offset)
{
    float min_proj = std::numeric_limits<float>::max();
    float max_proj = std::numeric_limits<float>::lowest();
...
inline SATAxisTest SATSolver::test_axis_2d(const ConvexHull2D &hull_a,
                                           const ConvexHull2D &hull_b,
                                           const Vec3f &axis,
                                           const Vec2f &transform_a,
                                           const Vec2f &transform_b)
...
inline SATAxisTest
SATSolver::test_axis_3d(const ConvexHull3D &hull_a, const ConvexHull3D &hull_b, const Vec3f &axis, const Vec3f &offset)
{
    SATAxisTest result;
    result.axis = axis;
...
inline Vec3f SATSolver::find_contact_point_2d(const ConvexHull2D &hull_a,
                                              const ConvexHull2D &hull_b,
                                              const Vec3f &normal,
                                              const Vec2f &offset)
{
...
inline Vec3f SATSolver::find_contact_point_3d(const ConvexHull3D &hull_a,
                                              const ConvexHull3D &hull_b,
                                              const Vec3f &normal,
                                              const Vec3f &offset)
{
...
inline SATCollisionResult SATSolver::test_convex_hull_2d(const ConvexHull2D &hull_a,
                                                         const ConvexHull2D &hull_b,
                                                         const Vec2f &transform_a,
                                                         const Vec2f &transform_b)
{
...
inline SATCollisionResult SATSolver::test_convex_hull_3d(const ConvexHull3D &hull_a,
                                                         const ConvexHull3D &hull_b,
