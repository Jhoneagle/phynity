...
public:
        ...
        const CollisionProxy &collider_a, const CollisionProxy &collider_b, size_t index_a, size_t index_b, float dt)
    {
        ...
        SweptSphereSolver::Sphere sphere_a{collider_a.position, collider_a.velocity, collider_a.radius};

        SweptSphereSolver::Sphere sphere_b{collider_b.position, collider_b.velocity, collider_b.radius};
        ...
        manifold.contact.relative_velocity_along_normal = toi_result.relative_velocity.dot(toi_result.contact_normal);
