...
public:
    ...
    SweptSphereSolver(const Sphere &sphere_a, const Sphere &sphere_b, float dt = 1.0f)
        : sphere_a_(sphere_a), sphere_b_(sphere_b), dt_(dt > 0.0f ? dt : 1.0f)
    {
    }
    ...
    static TimeOfImpactResult solve_static(const Sphere &sphere_a, const Sphere &sphere_b, float dt = 1.0f);
...
private:
    ...
    static Vec3f compute_contact_point(float time, const Sphere &sphere_a, const Sphere &sphere_b);
    ...
    static Vec3f compute_contact_normal(float time, const Sphere &sphere_a, const Sphere &sphere_b);
    ...
    static Vec3f compute_relative_velocity(const Sphere &sphere_a, const Sphere &sphere_b);
};
