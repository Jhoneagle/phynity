...
public:
    ...
    static RaySpherIntersection raycast_sphere(
    ...
    static RaySpherIntersection sweep_sphere_vs_sphere_static(
    ...
    static RaySpherIntersection sweep_sphere_vs_aabb(
        const Vec3f& sphere_center,
    ...
    static float compute_closest_approach_time(
        const Vec3f& pos1,
        const Vec3f& vel1,
        const Vec3f& pos2,
        const Vec3f& vel2
    ...
    static bool are_spheres_approaching(
        const Vec3f& pos1,
        const Vec3f& vel1,
        const Vec3f& pos2,
        const Vec3f& vel2
