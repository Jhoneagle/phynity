...
public:
	...
	static ConvexHull2D create_regular_polygon_2d(size_t sides = 6,
	                                              float radius = 1.0f,
	...
	static ConvexHull3D create_box_3d(float half_width = 1.0f,
	...
	static ConvexHull3D create_tetrahedron_3d(float edge_length = 1.0f, const Vec3f &center = Vec3f(0.0f))
	{
	...
	static ConvexHull3D
	create_cylinder_3d(float radius = 1.0f, float height = 2.0f, size_t sides = 8, const Vec3f &center = Vec3f(0.0f))
	{
		if (sides < 3)
		{
