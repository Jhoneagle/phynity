...
template <std::size_t N, typename T = float> struct IntegrationState
{
	...
	IntegrationState(const VecN<N, T> &p, const VecN<N, T> &v, T t = T(0)) : position(p), velocity(v), time(t)
	{
	}
};
...
inline void integrate_forward_euler(IntegrationState<N, T> &state, const F &acceleration, T dt)
{
...
/// @param dt Timestep
template <std::size_t N, typename T = float, typename F>
inline void integrate_semi_implicit_euler(IntegrationState<N, T> &state, const F &acceleration, T dt)
{
...
/// @param dt Timestep
template <std::size_t N, typename T = float, typename F>
inline void integrate_velocity_verlet(IntegrationState<N, T> &state, const F &acceleration, T dt)
{
...
/// @param dt Timestep
template <std::size_t N, typename T = float, typename F>
inline void integrate_rk4(IntegrationState<N, T> &state, const F &acceleration, T dt)
{
...
template <std::size_t N, typename T = float, typename F>
inline void integrate(IntegrationState<N, T> &state,
