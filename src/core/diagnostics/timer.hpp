...
public:
    ...
    [[nodiscard]] uint64_t lap() noexcept
    {
        ...
        return static_cast<uint64_t>(
            std::chrono::duration_cast<std::chrono::microseconds>(lap_time_ - start_time_).count());
    }
    ...
    [[nodiscard]] uint64_t elapsed_microseconds() const noexcept
    {
        ...
        return static_cast<uint64_t>(std::chrono::duration_cast<std::chrono::microseconds>(end - start_time_).count());
    }
...
public:
     ...
     */
    explicit ScopedTimer(uint64_t &out_duration_us) noexcept : out_duration_(out_duration_us)
    {
        timer_.start();
    }
