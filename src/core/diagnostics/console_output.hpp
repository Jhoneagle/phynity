...
public:
    ...
    static void print_frame_stats(const FrameProfiler &profiler)
    {
        ...
        std::cout << "\n=== Frame Statistics ===\n";
        std::cout << std::left << std::setw(25) << "Zone" << std::right << std::setw(10) << "Avg (ms)" << std::setw(10)
                  << "Min (ms)" << std::setw(10) << "Max (ms)" << std::setw(10) << "Count" << "\n";
        ...
        std::cout << std::left << std::setw(25) << "Total Frame Time" << std::right << std::setw(10) << std::fixed
                  << std::setprecision(3) << frame_ms << " ms\n";
        std::cout << "========================\n\n";
    }
    ...
    static void print_energy_status(const EnergyMonitor &monitor)
    {
        ...
        std::cout << "Current energy: " << std::fixed << std::setprecision(2) << monitor.get_current_energy() << "\n";
        std::cout << "======================\n\n";
    }
    ...
    static void print_momentum_status(const MomentumMonitor &monitor)
    {
        ...
        std::cout << "Enabled: " << (monitor.is_enabled() ? "Yes" : "No") << "\n";
        std::cout << "Frame: " << monitor.get_frame_count() << "\n";
        std::cout << "Current momentum: (" << std::fixed << std::setprecision(2) << momentum.x << ", " << momentum.y
                  << ", " << momentum.z << ")\n";
    ...
    static void print_collision_status(const CollisionMonitor &monitor)
    {
        ...
        std::cout << "Efficiency: " << std::fixed << std::setprecision(1) << (stats.efficiency * 100.0) << "%\n";
     ...
     */
    static void print_full_diagnostics_report(const FrameProfiler *frame_profiler = nullptr,
