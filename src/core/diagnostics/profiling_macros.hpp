 ...
 */
#define PROFILE_SCOPE(name) ::phynity::diagnostics::ProfileScope PHYNITY_PROFILE_CONCAT(_profile_scope_, __LINE__)(name)
 ...
 */
#define PROFILER_ENABLE(enabled) ::phynity::diagnostics::Profiler::enable(enabled)
 ...
 * ```
 */
#define PROFILER_CLEAR_FRAME() ::phynity::diagnostics::Profiler::clear_frame()
 ...
 * ```
 */
#define PROFILER_GET_ZONES() ::phynity::diagnostics::Profiler::get_zones()
