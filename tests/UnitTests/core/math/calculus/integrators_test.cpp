...
TEST_CASE("Integrators: Constant velocity motion", "[calculus][integrators]")
{
    ...
    auto zero_acceleration = []([[maybe_unused]] const VecN<1, float> &pos,
                                [[maybe_unused]] const VecN<1, float> &vel,
                                [[maybe_unused]] float t) { return VecN<1, float>(0.0f); };
...
TEST_CASE("Integrators: Constant acceleration (free fall)", "[calculus][integrators]")
{
    ...
    auto gravity = [g]([[maybe_unused]] const VecN<1, float> &pos,
                       [[maybe_unused]] const VecN<1, float> &vel,
                       [[maybe_unused]] float t) { return VecN<1, float>(-g); };
...
TEST_CASE("Integrators: Harmonic oscillator - energy conservation", "[calculus][integrators]")
{
    ...
    auto spring_force =
        [omega_sq](const VecN<1, float> &pos, [[maybe_unused]] const VecN<1, float> &vel, [[maybe_unused]] float t)
...
TEST_CASE("Integrators: 3D motion - gravity", "[calculus][integrators]")
{
    ...
    auto gravity_3d = []([[maybe_unused]] const VecN<3, float> &pos,
                         [[maybe_unused]] const VecN<3, float> &vel,
    ...
    IntegrationState<3, float> state(VecN<3, float>(std::array<float, 3>{0.0f, 10.0f, 0.0f}),
...
{
    auto gravity = []([[maybe_unused]] const VecN<1, float> &pos,
                      [[maybe_unused]] const VecN<1, float> &vel,
                      [[maybe_unused]] float t) { return VecN<1, float>(-EARTH_GRAVITY); };
...
TEST_CASE("Integrators: State update order", "[calculus][integrators]")
{
    ...
    auto constant_accel = []([[maybe_unused]] const VecN<1, float> &pos,
                             [[maybe_unused]] const VecN<1, float> &vel,
                             [[maybe_unused]] float t) { return VecN<1, float>(1.0f); };
