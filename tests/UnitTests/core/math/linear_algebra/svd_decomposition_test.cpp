...
{
    MatN<3, 3, float> D(std::array<float, 9>{2, 0, 0, 0, 3, 0, 0, 0, 5});
...
{
    // A = [[1, 2, 3], [4, 5, 6], [7, 8, 9]]
    MatN<3, 3, float> A(std::array<float, 9>{1, 2, 3, 4, 5, 6, 7, 8, 9});
...
{
    MatN<3, 3, float> A(std::array<float, 9>{1, 2, 3, 4, 5, 6, 7, 8, 10});
