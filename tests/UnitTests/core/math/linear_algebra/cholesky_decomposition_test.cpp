...
TEST_CASE("Cholesky: Diagonal matrix", "[linear_algebra][cholesky]")
{
    ...
    MatN<3, 3, float> D(std::array<float, 9>{4, 0, 0, 0, 9, 0, 0, 0, 16});
...
TEST_CASE("Cholesky: 3x3 SPD matrix", "[linear_algebra][cholesky]")
{
    ...
    MatN<3, 3, float> A(std::array<float, 9>{2, 1, 0, 1, 3, 1, 0, 1, 2});
...
{
    MatN<3, 3, float> A(std::array<float, 9>{4, 0, 0, 0, 9, 0, 0, 0, 16});
...
TEST_CASE("Cholesky: 4x4 SPD covariance-like matrix", "[linear_algebra][cholesky]")
{
    ...
    MatN<4, 4, float> A(std::array<float, 16>{4, 1, 0.5f, 0.2f, 1, 3, 0.3f, 0.1f, 0.5f, 0.3f, 2, 0, 0.2f, 0.1f, 0, 1});
...
TEST_CASE("Cholesky: Efficiency comparison - solve vs LU", "[linear_algebra][cholesky]")
{
    ...
    MatN<3, 3, float> A(std::array<float, 9>{4, 1, 0, 1, 3, 1, 0, 1, 2});
