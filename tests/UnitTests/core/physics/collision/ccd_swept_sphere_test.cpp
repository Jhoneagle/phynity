...
TEST_CASE("linear_cast::raycast_sphere", "[unit][physics][collision][ccd]") {
    SECTION("Ray hits sphere head-on") {
        ...
        auto result = LinearCast::raycast_sphere(
            ray_origin, ray_direction, 10.0f, sphere_center, sphere_radius
        );
    ...
    SECTION("Ray misses sphere") {
        ...
        auto result = LinearCast::raycast_sphere(
            ray_origin, ray_direction, 1.0f, sphere_center, sphere_radius
        );
...
TEST_CASE("ConservativeAdvancement::sphere_sphere", "[unit][physics][collision][ccd]") {
    SECTION("Finds contact time for head-on approach") {
        ...
        TimeOfImpactResult result = ConservativeAdvancement::solve_sphere_sphere(
            sphere_a,
            sphere_b,
            1.0f,
            16,
