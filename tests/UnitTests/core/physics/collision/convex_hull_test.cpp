...
{
    std::vector<Vec2f> vertices = {Vec2f(-1.0f, -1.0f), Vec2f(1.0f, -1.0f), Vec2f(1.0f, 1.0f), Vec2f(-1.0f, 1.0f)};
...
{
    // CCW vertices
    std::vector<Vec2f> ccw_vertices = {Vec2f(-1.0f, -1.0f), Vec2f(1.0f, -1.0f), Vec2f(1.0f, 1.0f), Vec2f(-1.0f, 1.0f)};
...
{
    std::vector<Vec2f> vertices = {Vec2f(0.0f, -1.0f), Vec2f(1.0f, 1.0f), Vec2f(-1.0f, 1.0f)};
...
{
    std::vector<Vec2f> vertices = {Vec2f(-2.0f, -3.0f), Vec2f(2.0f, -3.0f), Vec2f(2.0f, 3.0f), Vec2f(-2.0f, 3.0f)};
...
{
    auto triangle = ShapeFactory::create_triangle_2d(Vec2f(0.0f, -1.0f), Vec2f(1.0f, 1.0f), Vec2f(-1.0f, 1.0f));
