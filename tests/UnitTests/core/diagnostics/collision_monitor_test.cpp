...
TEST_CASE("CollisionMonitor: Efficiency violation detection", "[diagnostics][collision_monitor]")
{
    ...
    monitor.set_violation_callback(
        [&]([[maybe_unused]] const CollisionEfficiencyViolation &v)
        {
            ++violation_count;
            last_violation = v;
        });
...
TEST_CASE("CollisionMonitor: Enable/disable monitoring", "[diagnostics][collision_monitor]")
{
    ...
    monitor.set_violation_callback([&]([[maybe_unused]] const CollisionEfficiencyViolation &v) { ++violation_count; });
...
TEST_CASE("CollisionMonitor: Narrowphase tracking", "[diagnostics][collision_monitor]")
{
    ...
    double narrowphase_hit_rate =
        static_cast<double>(stats.actual_collisions) / static_cast<double>(stats.narrowphase_tests);
